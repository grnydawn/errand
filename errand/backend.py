...
"""
    ...
    def gen_program(self):
        ...
        code = self.code_template.format(top=top, header=header,
            use=use, impt=impt, varclass=varclass, vardef=vardef,
